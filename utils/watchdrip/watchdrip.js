			...
			this.messageBuilder
				...
				.finally(() => {
					try
					{
						this.updateFinish();					
						this.updateWidgets();
						if(!this.isAOD() && this.lastUpdateSucessful && this.watchdripData.getBg().time<=(this.timeSensor.utc-300000))
						{
							this.nextUpdateTime=this.timeSensor.utc+10000;
						}
						else if(this.lastUpdateSucessful && this.watchdripData.getBg().time>(this.timeSensor.utc-300000))
						{
							this.nextUpdateTime=this.watchdripData.getBg().time+300000;
							this.dropConnection();
						}
